		<div id="sidebar" class="sidebar">
			<div id="sidebar-drop" class="sidebar-drop"></div>
			<div class="sidebar-wrapper d-flex flex-column">
				<a href="#" id="sidebar-close" class="sidebar-close d-xl-none">&times;</a>
				<div class="brand">
					<a class="logo" href="index.php">
						<i class="bi bi-emoji-smile-fill brand-logo-icon me-2"></i>
						<span class="brand-logo-text"><?= strtoupper($title) ?> </span>
					</a>
				</div>

				<nav id="sidebar-nav-main" class="app-nav sidebar-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item has-submenu">
							<a class="nav-link active submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false" aria-controls="submenu-1">
								<span class="nav-icon">
